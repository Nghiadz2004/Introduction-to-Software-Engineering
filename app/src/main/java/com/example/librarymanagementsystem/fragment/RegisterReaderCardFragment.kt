 ...
 * Use the [RegisterReaderCardFragment.newInstance] factory method to
...
class RegisterReaderCardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegisterReaderCardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegisterReaderCardFragment().apply {
